...
// // Simulate a basic login page with an exposed vulnerability to XSS
// app.get('/', (req, res) => {
//   res.send(`
//     <html>
//       <body>
...
// // The login route, without proper input sanitization, potentially vulnerable to XSS
// app.post('/login', (req, res) => {
//   const { username, password } = req.body;
...
//   // This is where the XSS vulnerability is: User input is directly inserted into HTML without sanitization.
//   res.send(`
//     <html>
//       <body>
